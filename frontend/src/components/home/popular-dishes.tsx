      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {dishes.map((dish, i) => (
            <article
              key={dish.id}
              className="group shine-border overflow-hidden rounded-2xl glass transition duration-500 hover:border-gold/40 hover:-translate-y-1"
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex items-center justify-between">
                  <span className="text-lg font-semibold">{formatPrice(Number(dish.price))}</span>
